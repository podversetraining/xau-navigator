        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="glass-panel rounded-lg p-12 gold-border-glow text-center max-w-lg">
            ...
            <p className="text-dim font-data text-xs">
              The AI system requires at least 75/100 confidence score across all three analysis layers before issuing a trade signal. Continue monitoring — conditions are updated every 15 minutes.
            </p>
          </div>
        </div>
